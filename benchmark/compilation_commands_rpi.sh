...
${CC} -c main.c ${FLAGS}
${CC} main.o a2time.o aifftr.o bitmnp.o idctrn.o puwmod.o rspeed.o tblook.o ttsprk.o eembc_adaptation.o ${FLAGS} -o multiple_algorithms_rpi
...
# ${CC} -c algorithms/*.c ${FLAGS}
# ${CC} -c main.c ${FLAGS}
# ${CC} main.o a2time.o aifftr.o bitmnp.o idctrn.o puwmod.o rspeed.o tblook.o ttsprk.o eembc_adaptation.o ${FLAGS} -o multiple_algorithms_continuous_anomalous_cheribsd
